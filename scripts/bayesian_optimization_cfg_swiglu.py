...
def objective_function(config):
    ...
    wrapped_objective = partial(objective_function_cfg, x=x)
    res = gp_minimize(wrapped_objective, [Categorical(block_sizes), Categorical(num_warps), Categorical(num_stages)], n_calls=config_count)
    del x
...
data_frame.to_csv('bao_data_swiglu.csv')
print(results)